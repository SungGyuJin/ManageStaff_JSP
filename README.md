...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;학원에서 JSP를 공부중 가장 처음 배운 개념입니다. 기타 자질구레한 기능등을 다 제외하고 순수 등록, 조회, 수정, 삭제의 개념만 이용한 게시판개념의 프로젝트입니다. 이 프로젝트는 직원정보를 등록, 조회, 수정, 삭제할 수 있는 아주 간단한 프로그램입니다. 직원정보를 등록, 수정, 삭제 완료시에는 모달창을 이용하였고, 유효성 검사시 나타나는 문제는 alert창을 활용하였습니다.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DB를 이용해서 등록, 조회, 수정, 삭제 기능을 구현하는 것에 초점을 두고 만든 프로그램입니다. 보기에는 너무나도 간단해 보이지만 처음 공부할땐 꽤나 애먹은 개념의 프로젝트입니다.
